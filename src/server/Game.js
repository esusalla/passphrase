...
class Game {
  ...
  getNextWord() {
    let word = categories.get(this.category)[randomFromInterval(0, categories.get(this.category).length)];
    while (this.seenWords.has(word)) word = categories.get(this.category)[randomFromInterval(0, categories.get(this.category).length)];
    return word;
  }
